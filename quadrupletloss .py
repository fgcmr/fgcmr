...
def rankloss_loss(labels, embeddings, margin, margin2, squared=False):
...
def _get_triplet_mask(labels):
    ...
    i_not_equal_j = indices_not_equal.unsqueeze(2).unsqueeze(3)#[16,16,1,1]
    ...
    # print('i_not_equal_j',i_not_equal_j)
    # print('i_not_equal_j', i_not_equal_j.size())
